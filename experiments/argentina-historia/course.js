...
window.COURSE = {
  ...
  manifest: [
    ...
    { id: "ctx-guerras-mundiales",  strand: "Contexto",      title: "(Caja negra) Las guerras mundiales",      prereqs: ["mapa-del-siglo"],                    importance: "black-box",  status: "stub" },
    ...
    { id: "ctx-guerra-fria",        strand: "Contexto",      title: "(Caja negra) La Guerra Fría",             prereqs: ["mapa-del-siglo"],                    importance: "black-box",  status: "stub" },
